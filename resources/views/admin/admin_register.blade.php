<x-guest-layout>
    <div class="min-h-screen flex flex-col items-center justify-center bg-gray-300">
        <div class="flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md">
            <div class="font-medium self-center text-xl sm:text-2xl uppercase text-gray-800">Register For Admin</div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="flex flex-col mb-6">
                        ...
                        <div class="relative">
                            ...
                            <input id="name" type="text" name="name"
                                ...
                                placeholder="E-Mail Address" :value="old('name')" required autofocus
                                autocomplete="name" />
                        </div>
                    ...
                    <div class="flex items-center mb-6 -mt-4">
                        <div class="flex ml-auto">
                            <a href="#"
                                class="inline-flex text-xs sm:text-sm text-blue-500 hover:text-blue-700">Forgot Your
                                Password?</a>
                        </div>
                    </div>
